...
-(void)setupViews{
    ...
    [phoneNumpplaceholderAr addAttribute:NSForegroundColorAttributeName value:[KDColor getC12Color] range:NSMakeRange(0, phoneNumpplaceholderAr.length)];
    ...
    [passwordplaceholderAr addAttribute:NSForegroundColorAttributeName value:[KDColor getC12Color] range:NSMakeRange(0, passwordplaceholderAr.length)];
