...
-(void)requestRemoteDataWithPage:(NSUInteger)page completeHandle:(void (^)(id))complete{
    ...
    LCEvaluateCellViewModel *eval = [[LCEvaluateCellViewModel alloc]initWithEvaluteStr:@"每当我情绪低落的时候我就会想想我为神马这么叼,每当我沾沾自喜的时候我就问自己为什吗比吊的人这么多" and:@[sonE1,sonE2,sonE3]];
    eval.imgURL = nil;
    ...
    LCEvaluateCellViewModel *eval2 = [[LCEvaluateCellViewModel alloc]initWithEvaluteStr:@"每当我情绪低落的时候我就会想想我为神马这么叼,每当我沾沾自喜的时候我就问自己为什吗比吊的人这么多" and:@[sonE1,sonE2,sonE3]];
    eval2.imgURL = nil;
    eval2.name = @"你全力以赴也打不败的男人";
    
    LCEvaluateCellViewModel *eval3 = [[LCEvaluateCellViewModel alloc]initWithEvaluteStr:@"每当我情绪低落的时候我就会想想我为神马这么叼,每当我沾沾自喜的时候我就问自己为什吗比吊的人这么多" and:@[sonE1,sonE2,sonE3]];
    eval3.imgURL = nil;
    eval3.name = @"你全力以赴也打不败的男人";
    
    [self.mutableDataArr addObjectsFromArray:@[eval1,eval2,eval3]];
