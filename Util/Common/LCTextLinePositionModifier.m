...
/*
 ...
 间距仍然用字体默认
 */
@implementation LCTextLinePositionModifier

- (instancetype)init {
    self = [super init];
    
    if (kiOS9Later) {
        _lineHeightMultiple = 1.34;//1.34   // for PingFang SC
    } else {
        _lineHeightMultiple = 1.3125;//1.3125 // for Heiti SC
    }
...
- (id)copyWithZone:(NSZone *)zone {
    LCTextLinePositionModifier *one = [self.class new];
    one->_font = _font;
